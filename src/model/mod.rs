...
impl ServiceEntityInfo {
  fn parse_alarm_control_panel(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::AlarmControlPanel(
  ...
  fn parse_binary_sensor(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::BinarySensor(
      services::BinarySensorInfo {
        entity_info,
  ...
  fn parse_button(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Button(services::ButtonInfo {
      entity_info,
      device_class: data.device_class,
    }))
  }

  fn parse_camera(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Camera(services::CameraInfo {
      entity_info,
    }))
  }

  fn parse_climate(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Climate(services::ClimateInfo {
      entity_info,
  ...
  fn parse_cover(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Cover(services::CoverInfo {
      entity_info,
  ...
  fn parse_date(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Date(services::DateInfo { entity_info }))
  }

  fn parse_date_time(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::DateTime(services::DateTimeInfo {
      entity_info,
    }))
  }

  fn parse_event(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Event(services::EventInfo {
      entity_info,
      device_class: data.device_class,
  ...
  fn parse_fan(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Fan(services::FanInfo {
      entity_info,
  ...
  fn parse_light(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Light(services::LightInfo {
      entity_info,
  ...
  fn parse_lock(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Lock(services::LockInfo {
      entity_info,
      assumed_state: data.assumed_state,
  ...
  fn parse_media_player(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::MediaPlayer(services::MediaPlayerInfo {
      entity_info,
  ...
  fn parse_number(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Number(services::NumberInfo {
      entity_info,
      device_class: data.device_class,
  ...
  fn parse_select(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Select(services::SelectInfo {
      entity_info,
      options: data.options,
    }))
  }

  fn parse_sensor(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Sensor(services::SensorInfo {
      entity_info,
  ...
  fn parse_switch(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Switch(services::SwitchInfo {
      entity_info,
      assumed_state: data.assumed_state,
      device_class: data.device_class,
    }))
  ...
  fn parse_text(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Text(services::TextInfo {
      entity_info,
  ...
  fn parse_text_sensor(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::TextSensor(services::TextSensorInfo {
      entity_info,
      device_class: data.device_class,
    }))
  }

  fn parse_time(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Time(services::TimeInfo { entity_info }))
  }

  fn parse_valve(data: &[u8]) -> Result<Self> {
    ...
    Ok(ServiceEntityInfo::Valve(services::ValveInfo {
      entity_info,
      assumed_state: data.assumed_state,
      device_class: data.device_class,
      supports_position: data.supports_position,
